...
class PySharkCapture(threading.Thread):
	def __init__(self, target_ip, file_timestamp, net_interface):
		"""
		Constructor
		...
		abs_file_path = os.path.join("C:\\pyshark\\", output_file_name)
		print("abs_file_path:", abs_file_path)
		self.session_information = SessionInformation(abs_file_path)

		# Start capturing data
		self.capture = pyshark.LiveCapture(interface=net_interface, output_file=abs_file_path)
...
if __name__=="__main__":
	PySharkCapture("192.168.0.45", "5", "Wi-Fi")
